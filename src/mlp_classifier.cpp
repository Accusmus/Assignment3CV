...
mlp_classifier::mlp_classifier(string data, string save, string load)
{
    data_filename = data;
...
float mlp_classifier::classifier_predict(string filename_to_load, Mat &sample){
    Ptr<ANN_MLP> model;
...
bool mlp_classifier::build_mlp_classifier( const string& data_filename, const string& filename_to_save, const string& filename_to_load){
    ...
    else
    {
        ...
        // 2. train classifier
        int layer_sz[] = { data.cols, 70, 70, class_count };
